...
data class DeadLetterMessage(
    ...
    override fun toString(): String =
        "DeadLetterMessage(id=$id, topic='$topic', messageKey=$messageKey, kafkaOffset=$kafkaOffset, partition=$partition, attemptCount=$attemptCount, processed=$processed, reprocess=$reprocess)"
}
